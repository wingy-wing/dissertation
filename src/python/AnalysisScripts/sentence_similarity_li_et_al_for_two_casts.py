...
def main(argv):
    ...
    sim = similarity(stories[cast_no1], stories[cast_no2], False)

    orig_stdout = sys.stdout
    save_path = os.path.join(os.path.expanduser('~'), 'workspace', 'Dissertation', 'resources', 'results', 'Survey Cast Similarities', 'li_et_al.dat')
    with open(save_path, "a") as g:
        g.write(cast_no1 + cast_no2 + ":" + `sim`+",")
